...
if __name__ == "__main__":
    ...
    # A cache hit cannot produce the optional availability plot, so only
    # short-circuit when that output was not requested.
    if cache_path.is_file() and not snakemake.params.plot_availability_matrix:
